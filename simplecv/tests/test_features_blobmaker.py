...
def test_blobmaker_blob_methods():
    ...
    first = blobs[0]
    for b in blobs:
        assert_is_instance(b.get_width(), int)
        assert_is_instance(b.get_height(), int)
        assert_is_instance(b.get_area(), float)
        assert_is_instance(b.get_max_x(), int)
        assert_is_instance(b.get_min_x(), int)
        assert_is_instance(b.get_max_y(), int)
        assert_is_instance(b.get_min_y(), int)
        ...
        assert_is_instance(b.get_contour(), list)
        assert_is_instance(b.get_aspect_ratio(), float)
        assert_is_instance(b.get_angle(), float)
