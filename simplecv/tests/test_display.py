...
def test_camera_undistort():
    ...
    fakeCamera.load_calibration("TestCalibration")
...
def test_find_blobsFromMask():
    ...
    results = [img]
    name_stem = "test_find_blobsFromMask"
    perform_diff(results,name_stem)
...
def test_image_new_smooth():
    ...
    result.append(img.bilateral_filter(diameter=14,sigmaColor=20, sigmaSpace=34))
    ...
    result.append(img.gaussian_blur((7,9), sigmaX=10 , sigmaY=12, grayscale=True))
