...
def test_diff_segmentation_add_image():
    ...
    assert_equals(d1.last_img.ndarray.data, img1_gray.ndarray.data)
    assert_equals(d1.curr_img.ndarray.data, img1_gray.ndarray.data)
    ...
    assert_equals(d2.color_img.ndarray.data, img2.ndarray.data)
    assert_equals(d2.curr_img.ndarray.data, img2_gray.ndarray.data)
    ...
    assert_equals(d3.last_img.ndarray.data, img3.ndarray.data)
    assert_equals(d3.color_img.ndarray.data, img3.ndarray.data)
    assert_equals(d3.curr_img.ndarray.data, img3.ndarray.data)
...
def test_diff_segmentation_get_raw_image():
    ...
    assert_equals(result.ndarray.data, diff_img.ndarray.data)
...
def test_diff_segmentation_state():
    ...
    assert_equals(mydict['last_img'].ndarray.data,
                  img.ndarray.data)
    ...
    assert_equals(d.last_img.ndarray.data, last_img.ndarray.data)
    assert_equals(d.diff_img.ndarray.data, diff_img.ndarray.data)
