...
def test_diff_segmentation_add_image():
    ...
    assert_equals(d1.last_img.data, img1_gray.data)
    assert_equals(d1.curr_img.data, img1_gray.data)
    ...
    assert_equals(d2.color_img.data, img2.data)
    assert_equals(d2.curr_img.data, img2_gray.data)
    ...
    assert_equals(d3.last_img.data, img3.data)
