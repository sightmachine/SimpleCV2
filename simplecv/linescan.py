    ...
    **EXAMPLE**
    ...
    def smooth(self, degree=3):
        ...
        **NOTES**
        ...
        front += smoothed
        front += self[-1 * degree:]
        retVal = LineScan(front, image=self.image, pointLoc=self.pointLoc,
    ...
    def normalize(self):
        ...
        **EXAMPLE**
        ...
        retVal = LineScan(list(temp[:]), image=self.image,
                          pointLoc=self.pointLoc, pt1=self.pt1, pt2=self.pt2)
        retVal._update(self)
        return retVal
    ...
    def derivative(self):
        ...
        **EXAMPLE**
        ...
        retVal = LineScan(d, image=self.image, pointLoc=self.pointLoc,
                          pt1=self.pt1, pt2=self.pt2)
    ...
    def resample(self, n=100):
        ...
        **EXAMPLE**
        ...
        pts = zip(x, y)
        retVal = LineScan(list(signal), image=self.image,
                          pointLoc=self.pointLoc, pt1=self.pt1, pt2=self.pt2)
        retVal._update(self)
        return retVal
    ...
    def fitToModel(self, f, p0=None):
        ...
        **EXAMPLE**
        ...
        yvals = f(xvals, *popt)
        retVal = LineScan(list(yvals), image=self.image,
                          pointLoc=self.pointLoc, pt1=self.pt1, pt2=self.pt2)
        retVal._update(self)
        return retVal
    ...
    def convolve(self, kernel):
        ...
        **SEE ALSO**
        ...
        retVal = LineScan(out, image=self.image, pointLoc=self.pointLoc,
    ...
    def createEmptyLUT(self, defaultVal=-1):
        ...
        **EXAMPLE**
        ...
        if isinstance(defaultVal, list) \
                or isinstance(defaultVal, tuple):
    ...
    def medianFilter(self, kernel_size=5):
        ...
        **EXAMPLE**
        ...
        retVal = LineScan(medfilt_array.astype("uint8").tolist(),
                          image=self.image, pointLoc=self.pointLoc,
                          pt1=self.pt1, pt2=self.pt2, x=self.col, y=self.row)
        retVal._update(self)
        return retVal
    ...
    def detrend(self):
        ...
        **EXAMPLE**
        ...
        retVal = LineScan(detrend_arr.astype("uint8").tolist(),
                          image=self.image, pointLoc=self.pointLoc,
                          pt1=self.pt1, pt2=self.pt2, x=self.col, y=self.row)
        retVal._update(self)
        return retVal
